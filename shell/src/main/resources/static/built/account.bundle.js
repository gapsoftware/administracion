...
var AppAccount = function (_React$Component) {
    _inherits(AppAccount, _React$Component);

    function AppAccount() {
        _classCallCheck(this, AppAccount);

        return _possibleConstructorReturn(this, (AppAccount.__proto__ || Object.getPrototypeOf(AppAccount)).apply(this, arguments));
    }

    _createClass(AppAccount, [{
        key: 'render',
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'h1',
                    null,
                    'P\xE1gina principal del contador m\xF3dulos Gemesys'
                )
            );
        }
    }]);
...
ReactDOM.render(React.createElement(AppAccount, null), document.getElementById('react'));
